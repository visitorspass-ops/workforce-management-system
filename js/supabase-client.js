...
async function pushViaBulkRpc(fnName, rows) {
...
export async function pushCuratedRows(rows) {
  return pushViaBulkRpc('bulk_insert_curated_packing', rows);
}

export async function pushWmsPresence(rows) {
  return pushViaBulkRpc('bulk_insert_wms_presence', rows);
}

export async function pushBenchmarkVersion(rows) {
  return pushViaBulkRpc('bulk_insert_benchmark_versions', rows);
}

export async function pushBrandFallback(rows) {
  return pushViaBulkRpc('bulk_insert_brand_fallback', rows);
}

export async function pushSkuMapping(rows) {
  return pushViaBulkRpc('bulk_insert_sku_mapping', rows);
}

export async function pushAttendance(rows) {
  return pushViaBulkRpc('bulk_insert_attendance', rows);
}
